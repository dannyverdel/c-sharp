using System;
namespace CSharpDemos.ClassLibrary.DesignPatterns.PrototypePattern.ConfigureFactoryWithPrototype
{
	public class InvokeConfigureFactoryWithPrototype : IInvokeMethod
	{
        public void InvokeMethod()
        {
            GardenFactory garden = new GardenFactory(
                new TreeSeed("Apple"),
                new GrassSeed("Red"),
    ...
    public class GardenFactory
    {
        ...
        public GardenFactory(Seed seed1, Seed seed2, Seed seed3)
        {
            _seed1 = seed1;
            _seed2 = seed2;
            _seed3 = seed3;
