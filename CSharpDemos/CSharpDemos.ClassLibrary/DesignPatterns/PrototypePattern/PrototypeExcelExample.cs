using System;
namespace CSharpDemos.ClassLibrary.DesignPatterns.PrototypePattern.PrototypeExcelExample
{
    public class InvokePrototypeExcelExample : IInvokeMethod
    {
        public void InvokeMethod()
        {
            ...
            grid.Add(BlockFactory.Create("07/25/2002"));
            grid.Dump();

            var block3 = (DateTimeBlock)grid[2].Clone();
            block3.Format = "dd-MM-yyyy";
            grid.Add(block3);
